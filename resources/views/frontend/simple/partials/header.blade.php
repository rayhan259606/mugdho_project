    ...
    <div class="container main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="index.html">
                <img src="{{ asset('backend') }}/images/brand/logo.svg" class="header-brand-img desktop-logo" alt="logo">
            ...
            <div class="container">
                <div class="main-sidemenu navbar px-0">
                    <a class="navbar-brand ps-0 d-none d-lg-block" href="index.html">
                        <img alt="" class="logo-2" src="{{ asset('backend') }}/images/brand/logo-3.png">
                        <img alt="" class="dark-landinglogo" src="{{ asset('backend') }}/images/brand/logo.svg">
                    </a>
                    <ul class="side-menu">
                        <li class="slide">
