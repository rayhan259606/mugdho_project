@extends('backend.app', ['title' => 'MSM Course FAQ'])
                    ...
                    <div class="card product-sales-main">
                        <div class="card-header border-bottom">
                            ...
                            <div class="card-options ms-auto">
                                <a href="{{ route('admin.msm_faq.create') }}" class="btn btn-primary btn-sm">Add</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="">
...
<script>
    ...
    function statusChange(id) {
        NProgress.start();
        let url = "{{ route('admin.msm_faq.status', ':id') }}";
        $.ajax({
            type: "GET",
    ...
    function deleteItem(id) {
        NProgress.start();
        let url = "{{ route('admin.msm_faq.destroy', ':id') }}";
    ...
    function goToEdit(id) {
        let url = "{{ route('admin.msm_faq.edit', ':id') }}";
        window.location.href = url.replace(':id', id);
    }
    function goToOpen(id) {
        let url = "{{ route('admin.msm_faq.show', ':id') }}";
        window.location.href = url.replace(':id', id);
    }
</script>
@endpush
