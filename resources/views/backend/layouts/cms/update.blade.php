                                        ...
                                        <div class="row{{ in_array('metadata', $components) ? '' : 'd-none' }}">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control @error('rating') is-invalid @enderror" name="rating" placeholder="Enter here rating" id="rating" value="{{ $data->metadata['rating'] ?? '' }}" min="1" max="5">
                                                    @error('rating')
