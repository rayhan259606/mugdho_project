@extends('backend.app', ['title' => 'Create Country'])
                ...
                <div class="col-lg-12">
                    <div class="card post-sales-main">
                        ...
                        <div class="card-body border-0">
                            <form class="form form-horizontal" method="POST" action="{{ route('admin.country.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('code') is-invalid @enderror" name="code" placeholder="Enter here code" id="code" value="{{ old('code') ?? '' }}">
                                                @error('code')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
