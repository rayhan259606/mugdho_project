@extends('backend.app', ['title' => 'Show Attribute'])
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <th>Action</th>
                                    <td>
                                        <button class="btn btn-sm btn-danger" onclick="showDeleteConfirm(`{{ $attribute->id }}`)">Delete</button>
                                        <button class="btn btn-sm btn-primary" onclick="goToEdit(`{{ $attribute->id }}`)">Edit</button>
                                    </td>
                                </tr>
                            </table>
                        </div>
