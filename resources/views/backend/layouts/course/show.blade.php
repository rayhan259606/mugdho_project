                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    <th>Action</th>
                                    <td>
                                        <button class="btn btn-sm btn-danger" onclick="showDeleteConfirm(`{{ $course->id }}`)">Delete</button>
                                        <button class="btn btn-sm btn-primary" onclick="goToEdit(`{{ $course->id }}`)">Edit</button>
                                    </td>
                                </tr>
                            </table>
                        </div>
