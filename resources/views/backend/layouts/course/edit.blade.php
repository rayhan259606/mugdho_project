                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="dropify" name="image" id="image" data-default-file="{{ asset($course->image) }}" />
                                                @error('image')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" name="price" placeholder="Enter course price" id="price" value="{{ $course->price ?? '' }}">
                                                @error('price')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
