                        ...
                        <div class="tab-pane active show" id="editProfile">
                            <div class="card">
                                ...
                                <div class="card-body border-0">
                                    <form class="form form-horizontal" method="post" action="{{ route('admin.subcategory.update', $subcategory->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('POST')
                                        <div class="row mb-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Name" id="" value="{{ $subcategory->name }}">
                                                @error('name')
