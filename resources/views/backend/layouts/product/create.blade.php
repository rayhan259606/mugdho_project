                ...
                <div class="col-lg-12">
                    <div class="card post-sales-main">
                        ...
                        <div class="card-body border-0">
                            <form class="form form-horizontal" method="POST" action="{{ route('admin.product.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control @error('price') is-invalid @enderror" name="price" placeholder="Enter here price" id="price" value="{{ old('price') ?? '' }}" min="0">
                                                @error('price')
