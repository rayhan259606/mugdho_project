...
class GadgetController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = Gadget::orderBy('position', 'asc')->orderBy('id', 'desc')->get();
        ...
        $cms = CMS::where('page', 'gadgets')->where('section', 'hero')->first();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $item->slug = Helper::makeSlug(Gadget::class, $data['title']);
            ...
            if ($request->hasFile('image')) {
                $item->thumbnail = Helper::fileUpload($request->file('image'), 'gadget', time() . '_' . getFileName($request->file('image')));
            }
    ...
    public function updateCms(Request $request)
    {
        ...
        try {
            $section = CMS::where('page', 'gadgets')->where('section', 'hero')->first();
            ...
            if ($request->hasFile('image')) {
                ...
                $data['image'] = Helper::fileUpload($request->file('image'), 'gadgets', time() . '_' . getFileName($request->file('image')));
            }
